...
const DICTS = {
  zh: {
    ...
    'tool.oviraptor': '窃蛋龙',
    'tool.pterosaur': '翼龙',
    'tool.ankylosaurus': '甲龙',
    'tool.parasaurolophus': '副栉龙',
    'tool.pachycephalosaurus': '肿头龙',
    'tool.dilophosaurus': '双冠龙',
    'tool.diplodocus': '梁龙',
    'tool.spinosaurus': '棘龙',
    'tool.therizinosaurus': '镰刀龙',
    'tool.mosasaurus': '沧龙',
    'tool.carnotaurus': '食肉牛龙',
    'tool.gallimimus': '似鸡龙',
    'tool.styracosaurus': '戟龙',
    'tool.compsognathus': '美颌龙',
    'tool.kentrosaurus': '钉状龙',
    'tool.iguanodon': '禽龙',
    'tool.baryonyx': '重爪龙',
    'tool.protoceratops': '原角龙',
    'tool.pteranodon': '无齿翼龙',
    'tool.plesiosaurus': '蛇颈龙',
    'tool.amargasaurus': '阿马加龙',
    'tool.pachyrhinosaurus': '厚鼻龙',
    'tool.dinos': '恐龙朋友',
    'action.daynight': '快进时间',
    'action.rainbow': '彩虹',
    'action.whistle': '吹哨召唤',
    'action.magic': '魔法',
  ...
  en: {
    ...
    'tool.bubble': 'Bubble Wand',
    'tool.tickle': 'Tickle',
    'tool.treat': 'Treat Ball',
    ...
    'tool.ankylosaurus': 'Ankylosaurus',
    'tool.parasaurolophus': 'Parasaurolophus',
    'tool.pachycephalosaurus': 'Pachycephalosaurus',
    'tool.dilophosaurus': 'Dilophosaurus',
    'tool.diplodocus': 'Diplodocus',
    'tool.spinosaurus': 'Spinosaurus',
    'tool.therizinosaurus': 'Therizinosaurus',
    'tool.mosasaurus': 'Mosasaurus',
    'tool.carnotaurus': 'Carnotaurus',
    'tool.gallimimus': 'Gallimimus',
    'tool.styracosaurus': 'Styracosaurus',
    'tool.compsognathus': 'Compsognathus',
    'tool.kentrosaurus': 'Kentrosaurus',
    'tool.iguanodon': 'Iguanodon',
    'tool.baryonyx': 'Baryonyx',
    'tool.protoceratops': 'Protoceratops',
    'tool.pteranodon': 'Pteranodon',
    'tool.plesiosaurus': 'Plesiosaurus',
    'tool.amargasaurus': 'Amargasaurus',
    'tool.pachyrhinosaurus': 'Pachyrhinosaurus',
    'tool.dinos': 'Dino Friends',
    'action.daynight': 'Skip Time',
    'action.rainbow': 'Rainbow',
    'action.whistle': 'Whistle',
    'action.magic': 'Magic',
